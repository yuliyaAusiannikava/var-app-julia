...
public class StringTask {
    ...
    public static void main(String[] args) {
       /* String text = "Java is a programming language originally developed by Sun Microsystems and released in 1995 as a " +
        ...
        String clientWord = sc.next();

        if (text.toLowerCase().contains(clientWord.toLowerCase())) {
            System.out.println("Your word contains in our text!");
            System.out.println("First " + text.lastIndexOf(clientWord));
        } else {
            System.out.println("Your word doesn't contain in our text!");
        }*/
